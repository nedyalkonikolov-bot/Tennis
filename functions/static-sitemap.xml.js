...
export async function onRequestGet({ request }) {
  ...
  const entries = [
    urlEntry("/", "2026-06-29", "hourly", "1.0"),
    urlEntry("/tennis-predictions/", "2026-06-29", "hourly", "0.98"),
    ...
    urlEntry("/wimbledon-predictions-today/", "2026-07-01", "hourly", "0.96"),
    urlEntry("/wimbledon-day-3-betting-preview/", "2026-07-01", "daily", "0.9"),
    urlEntry("/best-wimbledon-underdog-picks/", "2026-07-01", "daily", "0.88"),
    urlEntry("/atp-wimbledon-predictions/", "2026-07-01", "hourly", "0.92"),
    urlEntry("/wta-wimbledon-predictions/", "2026-07-01", "hourly", "0.92"),
    ...
    urlEntry("/responsible-gambling/", "2026-06-29", "monthly", "0.78"),
    urlEntry("/privacy/", "2026-06-29", "yearly", "0.42"),
    urlEntry("/terms/", "2026-06-29", "yearly", "0.42"),
    urlEntry("/br/previsoes-tenis/", "2026-06-29", "daily", "0.88"),
    urlEntry("/br/sites-apostas-tenis/", "2026-06-29", "weekly", "0.86"),
    urlEntry("/bd/tennis-predictions/", "2026-06-29", "daily", "0.84"),
    urlEntry("/bd/crypto-tennis-sites/", "2026-06-29", "weekly", "0.78"),
    urlEntry("/tr/tenis-tahminleri/", "2026-06-29", "daily", "0.84"),
    urlEntry("/tr/kripto-tenis-siteleri/", "2026-06-29", "weekly", "0.78"),
  ];
