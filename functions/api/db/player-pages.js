...
export async function onRequestGet({ request, env }) {
  ...
  return jsonResponse({ ok: true, generatedAt: new Date().toISOString(), statSource: "API-Tennis standings, 2026 get_players season stats, and verified 100-day fixture/settled match results", seasonStatsYear: SEASON_STATS_YEAR, players });
}
