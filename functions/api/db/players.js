...
export async function onRequestGet({ request, env }) {
  ...
  return jsonResponse({ ok: true, generatedAt: new Date().toISOString(), statSource: "API-Tennis standings, get_players season stats, and 100-day fixture results", players: result.results || [] });
}
