...
const STATIC_URLS = [
  ["/", "1.0", "hourly"],
  ["/tennis-predictions/", "0.98", "hourly"],
  ["/tennis-predictions-today/", "0.96", "hourly"],
  ["/atp-predictions/", "0.92", "hourly"],
  ["/wta-predictions/", "0.92", "hourly"],
  ["/player-stats/", "0.90", "daily"],
  ["/players/atp/", "0.88", "daily"],
  ["/players/wta/", "0.88", "daily"],
  ["/tennis-news/", "0.85", "hourly"],
  ["/tennis-betting/", "0.90", "weekly"],
  ["/crypto-tennis-betting/", "0.90", "weekly"],
  ["/best-tennis-betting-sites/", "0.86", "weekly"],
  ["/betting-sites/", "0.86", "weekly"],
];
...
export async function onRequestGet({ env }) {
  const entries = STATIC_URLS.map(([path, priority, changefreq]) => urlEntry(path, priority, changefreq));
